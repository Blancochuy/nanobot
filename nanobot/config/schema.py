...
if TYPE_CHECKING:
    ...
    from nanobot.agent.tools.stripe import StripeSubscriptionReportConfig
...
def _resolve_tool_config_refs() -> None:
    ...
    mod.StripeSubscriptionReportConfig = StripeSubscriptionReportConfig  # type: ignore[attr-defined]
